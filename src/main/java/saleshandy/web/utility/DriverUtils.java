package saleshandy.web.utility;
...
import saleshandy.web.constants.WebDriverConstants;
	...
	public void downloadFile(String DriverName, OSCheck.OSType osType) {
		...
		try {
			...
			case MacOS:
				...
				fileDownloader.unGunzipFile(dirName + DriverName + ".zip", dirName,
						dirName + File.separator + DriverName);
